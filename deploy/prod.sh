...
redis_ip=$(node /root/DevOps-Project/deploy/provision/digitalocean.js)
...
proxy_ip=$(node /root/DevOps-Project/deploy/provision/digitalocean.js)
...
## Deploy
ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i inventory /root/DevOps-Project/deploy/configure_prod.yml