...
# Deploy
ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i inventory playbook.yml --limit redisserver
...
# Deploy
ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i inventory playbook.yml --limit proxyserver
...
## Deploy
ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -i inventory playbook.yml --limit appserver
